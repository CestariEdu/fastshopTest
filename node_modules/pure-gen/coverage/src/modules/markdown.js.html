...
<head>
    <title>Code coverage report for src/modules/markdown.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> markdown.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Markdown {
    constructor(pure) {
        this.header = (num = 1) =&gt; {
            const head = pure.helpers.repeatString({ string: '#', num });
<span class="branch-0 cbranch-no" title="branch not covered" >            return `${head} ${pure.lorem.word()}`;</span>
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return table.join('\n');</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return list.join('\n');</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
