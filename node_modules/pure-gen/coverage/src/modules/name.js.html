...
<head>
    <title>Code coverage report for src/modules/name.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> name.js</h1>
        <div class='clearfix'>
...
&nbsp;
            if (maleVerification &amp;&amp; femaleVerification) {
                ...
                if (typeof def !== 'number') {
                    if (typeof pure.registeredModules.name.first_name === 'undefined') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                        def = pure.random.number(1);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >                        if (def === 0) {</span>
<span class="cstat-no" title="statement not covered" >                            result = pure.random.arrayElement(pure.registeredModules.name.male_first_name);</span>
<span class="cstat-no" title="statement not covered" >                        } else {</span>
<span class="cstat-no" title="statement not covered" >                            result = pure.random.arrayElement(pure.registeredModules.name.female_first_name);</span>
<span class="cstat-no" title="statement not covered" >                        }</span>
                    } else {
...
&nbsp;
            if (maleVerification<span class="branch-0 cbranch-no" title="branch not covered" > &amp;&amp; femaleVerification) <span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >                // some locale datasets ( like ru ) have last_name split by gender.</span>
<span class="cstat-no" title="statement not covered" >                // i have no idea how last names can have genders, but also i do not speak russian</span>
<span class="cstat-no" title="statement not covered" >                // see above comment of firstName method</span>
<span class="cstat-no" title="statement not covered" >                if (typeof def !== 'number') {</span>
<span class="cstat-no" title="statement not covered" >                    def = pure.random.number(1);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >                if (def === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    return pure.random.arrayElement(pure.registeredModules.name.male_last_name);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >                return pure.random.arrayElement(pure.registeredModules.name.female_last_name);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
&nbsp;
...
&nbsp;
            if (r === 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                result = `${prefix} ${fName} ${lName}`;</span>
            } else if (r === 1) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                result = `${fName} ${lName} ${suffix}`;</span>
            } else {
                result = `${fName} ${lName}`;
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                if (def === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    return pure.random.arrayElement(pure.registeredModules.name.male_prefix);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                return pure.random.arrayElement(pure.registeredModules.name.female_prefix);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
