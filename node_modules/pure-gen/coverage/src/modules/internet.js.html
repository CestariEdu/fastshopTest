...
<head>
    <title>Code coverage report for src/modules/internet.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> internet.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">94.02% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>189/201</span>
            </div>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const RandExp = require('randexp');
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return `${pure.helpers.slugify(this.userName({ firstName, lastName }), { lower: true })}@${provider}`;</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
        this.exampleEmail = (options = {}) =&gt; {
            const { firstName, lastName } = options;
            const provider = pure.random.arrayElement(pure.registeredModules.internet.example_email);
<span class="branch-0 cbranch-no" title="branch not covered" >            return this.email({ firstName, lastName, provider });</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                result = firstName + pure.random.number(99);</span>
            } else if (r === 1) {
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return `${protocol}://${domainName}`;</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                name = slugify(pure.lorem.word(), { lower: true, strict: true });</span>
<span class="cstat-no" title="statement not covered" >            }</span>
&nbsp;
            return name;
        };
...
<span class="branch-0 cbranch-no" title="branch not covered" >            return `#${redStr.length === 1 ? '0' : ''}${redStr}${greenStr.length === 1 ? '0' : ''}`</span>
<span class="cstat-no" title="statement not covered" >            + `${greenStr}${blueStr.length === 1 ? '0' : ''}${blueStr}`;</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
        this.mac = (sep) =&gt; {
            let i;
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return prefix.substr(0, len);</span>
<span class="cstat-no" title="statement not covered" >        };</span>
    }
}
&nbsp;
