...
<head>
    <title>Code coverage report for src/modules/date.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> date.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">98.85% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>173/175</span>
            </div>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class pureDate {
    constructor(pure) {
        this.past = (options) =&gt; {
            const def = options<span class="branch-0 cbranch-no" title="branch not covered" > || {};</span>
...
&nbsp;
        this.recent = (options) =&gt; {
            ...
            let date = new Date();
&nbsp;
            if (typeof refDate !== 'undefined') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                date = new Date(Date.parse(refDate));</span>
