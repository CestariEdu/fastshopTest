...
<head>
    <title>Code coverage report for src/modules/helpers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> helpers.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">97.79% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>311/318</span>
            </div>
...
&nbsp;
            for (let i = 0; i &lt; string.length; i += 1) {
                ...
                } else if (string.charAt(i) === '!') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                    str += pure.random.number({ min: 2, max: 9 });</span>
                } else {
                    str += string.charAt(i);
                }
            }
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return str;</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >            return str.replace('L', checkNum);</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
        this.repeatString = (options = {}) =&gt; {
            const { string = '', num = 0 } = options;
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return string.repeat(num);</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return mustache.render(str, data);</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return m;</span>
<span class="cstat-no" title="statement not covered" >        };</span>
&nbsp;
