...
<head>
    <title>Code coverage report for src/modules/git.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> git.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Git {
    constructor(pure) {
        this.branch = () =&gt; {
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >            return pure.fake(entry);</span>
