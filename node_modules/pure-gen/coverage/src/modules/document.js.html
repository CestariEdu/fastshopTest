...
<head>
    <title>Code coverage report for src/modules/document.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> document.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Document {
    constructor(pure) {
...
&nbsp;
                return <span class="branch-0 cbranch-no" title="branch not covered" >modResult &lt; 2 ? 0 : 1</span>1 - modResult;
            };
&nbsp;
            doc += '0001';
            doc += mod(doc);
