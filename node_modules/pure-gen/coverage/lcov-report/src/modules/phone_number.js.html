...
<head>
    <title>Code coverage report for src/modules/phone_number.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> phone_number.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Phone {
    constructor(pure) {
...
&nbsp;
        ...
        this.phoneNumberFormat = (phoneFormatsArrayIndex) =&gt; {
            const format = phoneFormatsArrayIndex<span class="branch-0 cbranch-no" title="branch not covered" > || 0;</span>
