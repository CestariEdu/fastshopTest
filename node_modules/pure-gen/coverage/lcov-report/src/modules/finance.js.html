...
<head>
    <title>Code coverage report for src/modules/finance.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> finance.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Finance {
    constructor(pure) {
        this.account = (length) =&gt; {
            const def = length || 8;
...
&nbsp;
            // set defaults
            const def = <span class="branch-0 cbranch-no" title="branch not covered" >(<span class="branch-0 cbranch-no" title="branch not covered" >length === 0 || !length || typeof length === 'undefined') ? 4</span> : length;</span>
            const nParens = <span class="branch-0 cbranch-no" title="branch not covered" >(parens === null) ? true : p</span>arens;
            const nEllipsis = <span class="branch-0 cbranch-no" title="branch not covered" >(ellipsis === null) ? true : e</span>llipsis;
&nbsp;
            let template = pure.helpers.repeatString({ string: '#', num: def });
&nbsp;
            // prefix with ellipsis
            template = <span class="branch-0 cbranch-no" title="branch not covered" >(nEllipsis) ? ['</span>...', template].join('') : template;
&nbsp;
            template = <span class="branch-0 cbranch-no" title="branch not covered" >(nParens) ? ['</span>(', template, ')'].join('') : template;
&nbsp;
