...
<head>
    <title>Code coverage report for src/modules/lorem.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> lorem.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Lorem {
    constructor(pure) {
        this.word = (length) =&gt; {
...
<span class="cstat-no" title="statement not covered" >                properLengthWords = pure.registeredModules.lorem.words.filter(hasRightLength.bind(this, length));</span>
<span class="cstat-no" title="statement not covered" >                if (properLengthWords.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    properLengthWords = pure.registeredModules.lorem.words.filter(hasRightLength.bind(this, 14));</span>
...
&nbsp;
        this.sentence = (wordCount) =&gt; {
            ...
            let sentence;
&nbsp;
            if (<span class="branch-0 cbranch-no" title="branch not covered" >sentences instanceof Object &amp;&amp; def in sentences) <span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >                sentence = pure.random.arrayElement(sentences[def]);</span>
            } else {
